...
#ifndef OPEN_SPIEL_GAMES_SIMPLE_POKER_H_
#define OPEN_SPIEL_GAMES_SIMPLE_POKER_H_
...
// http://en.wikipedia.org/wiki/Simple_poker
//
...
// http://mlanctot.info/files/papers/aamas14sfrd-cfr-simple.pdf
//
// Parameters:
...
inline constexpr const int kNumInfoStatesP0 = 20;
inline constexpr const int kNumInfoStatesP1 = 20;
...
class SimpleGame : public Game {
 public:
  ...
  std::shared_ptr<SimpleObserver> default_observer_;
  std::shared_ptr<SimpleObserver> info_state_observer_;
  std::shared_ptr<SimpleObserver> public_observer_;
...
#endif  // OPEN_SPIEL_GAMES_SIMPLE_POKER_H_
