...
_GAME_TYPE = pyspiel.GameType(
    short_name="python_blind_poker",
    long_name="Python Blind Poker",
...
class BlindPokerGame(pyspiel.Game):
  """A Python version of Blind poker."""
  ...
  def new_initial_state(self):
    ...
    return BlindPokerState(self)

  def make_py_observer(self, iig_obs_type=None, params=None):
    """Returns an object used for observing game state."""
    return BlindPokerObserver(
        iig_obs_type or pyspiel.IIGObservationType(perfect_recall=False),
        params)


class BlindPokerState(pyspiel.State):
  """A python version of the Blind poker state."""
